...
if [[ "$OSTYPE" == "darwin"* ]]; then
    ...
    if [[ "$(uname -m)" == "arm64" ]]; then
        MINICONDA_URL="https://repo.anaconda.com/miniconda/Miniconda3-py310_24.5.0-0-MacOSX-arm64.sh"
        MINICONDA_INSTALLER="Miniconda3-py310_24.5.0-0-MacOSX-arm64.sh"
    else
