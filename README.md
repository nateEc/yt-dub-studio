...
[Setup Guide](docs/setup.md) · [YouTube Pipeline Notes](docs/youtube-pipeline-app.md) · [Lip Sync Notes](docs/lipsync-pipeline.md)
...
More commands live in the [setup guide](docs/setup.md).
