...
[![五分钟中文配音 Demo 预览](docs/demo/wtf-loop-engineer-preview.gif)](https://github.com/nateEc/yt-dub-studio/releases/download/demo-v1/wtf-loop-engineer-first5-sourcevoice-wav2lip.mp4)

点击上方预览可打开完整 5 分钟 MP4 Demo（含音频）。完整视频托管在 GitHub Release assets，仓库当前 checkout/源码包只保留轻量 GIF 预览。

演示视频分发方案见：[Demo Assets](docs/demo-assets.md)。
