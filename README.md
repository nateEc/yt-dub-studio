...
[![五分钟中文配音 Demo 预览](docs/demo/wtf-loop-engineer-preview.gif)](docs/demo/wtf-loop-engineer-first5-sourcevoice-wav2lip.mp4)

GitHub README 会过滤仓库内的 `<video>` 标签；点击上方预览可打开完整 5 分钟 MP4 Demo（含音频）。
